...
public class GlobalExceptionHandler {
	...
	// New Exception Handler for UniqueKeyViolationException
	@ExceptionHandler(UniqueKeyViolationException.class)
	public ResponseEntity<ErrorDetails> handleUniqueKeyViolationException(UniqueKeyViolationException ex,
			WebRequest request) {
